...
인턴 근무 당시 클라이언트사로부터 받은 증빙자료 중 일부는 화질이 낮아 담당자 정보·문서번호·금액 등을 식별하기 어려웠고, 매번 자료를 재요청해야 하는 비효율이 있었습니다. 이 문제를 해결하기 위해 문서 이미지의 텍스트 영역을 선명하게 복원하는 SR 모델을 직접 학습했습니다.
